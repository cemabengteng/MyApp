...
public class ComBoView extends BaseRelativelayout {
    ...
    public static final int TYPE_OF_SHOW = -1; // 展示模式，用在快捷礼物下，第一点击时，展示连击动画，再次点击则赠送
    public static final int TYPE_OF_SEND = -2; // 赠送模式，用在礼物列表下，每次点击都赠送，显示时展示动画
