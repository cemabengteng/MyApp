...
/**
 * Created by chengXing on 2017/3/29.
 */

public class EmmaService2 extends Service {

    private static final String TAG = EmmaService.class.getSimpleName();
    ...
    private static boolean IS_Coverage = true;
    ...
    private void init() {
        DEFAULT_COVERAGE_FILE_PATH_MEMORY_DIR = getFilesDir().getAbsolutePath() + File.separator + "coverageTest";
        DEFAULT_COVERAGE_FILE_PATH_SDCARD_DIR = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "coverageTest";
        createLogDir();
